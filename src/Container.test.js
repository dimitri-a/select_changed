...
describe('Container select visibility tests | 128, 129, 312', () => {
    ...
    xit('should default newlimit to zero when debType is Clear close or Clear and convert | 312-ac3 ', () => {
    ...
    xit('should default newlimit to currentLimit when debType is No Change, Variation, Disbursement Only | 312-ac3 ', () => {
        //when debtType is Clear close/Clear and convert
        const myComp = shallow(<Container/>);
